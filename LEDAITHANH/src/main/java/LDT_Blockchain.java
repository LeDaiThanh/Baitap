...
public class LDT_Blockchain {
    public static ArrayList<VNPT_THANH> blockchain = new ArrayList<VNPT_THANH>();
    public static HashMap<String,TransactionOutput> UTXOs = new HashMap<String,TransactionOutput>();
    public static int difficulty = 3;
    public static float minimumTransaction = 0.1f;
    public static Wallet storeA; //Ví A
    public static Wallet storeB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        VNPT_THANH genesis = new VNPT_THANH("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        //Thử nghiệm
        VNPT_THANH block1 = new VNPT_THANH(genesis.hash);
        System.out.println("\nSố dư của ví A là : " + storeA.getBalance());
        System.out.println("\nGiao dịch chuyển số tiền là 40 từ ví A đến ví B...");
        block1.addTransaction(storeA.sendFunds(storeB.publicKey, 40f));
        addBlock(block1);

        isChainValid();
    }
    public static Boolean isChainValid() {
        VNPT_THANH currentBlock;
        VNPT_THANH previousBlock;
    ...
    public static void addBlock(VNPT_THANH newBlock) {
